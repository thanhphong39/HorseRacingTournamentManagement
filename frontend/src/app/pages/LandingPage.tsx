          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <div className="relative group">
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium text-slate-300 hover:text-white hover:bg-white/5 transition-all group"
              >
              ...
              <div className="absolute top-full left-0 mt-2 w-64 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 translate-y-1 group-hover:translate-y-0">
                <div className="bg-slate-900 border border-white/10 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden p-2">
                  ...
                  {[
                    { label: 'Đang Diễn Ra', desc: '1 giải trực tiếp', icon: '🔴', path: '/tournaments' },
                    { label: 'Sắp Diễn Ra', desc: '3 giải sắp tới', icon: '🔵', path: '/tournaments' },
                    { label: 'Lịch Sử', desc: 'Kết quả đã qua', icon: '📋', path: '/tournaments' },
                    { label: 'Vô Địch Quốc Gia', desc: 'Giải đấu cao nhất', icon: '🏆', path: '/tournaments' },
                  ].map(item => (
                    <button
                      key={item.label}
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-2 w-60 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 translate-y-1 group-hover:translate-y-0">
                <div className="bg-slate-900 border border-white/10 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden p-2">
                  ...
                  {[
                    { label: 'Ngựa Đua', desc: 'Top ngựa mùa 2026', icon: '🐎', path: '/rankings' },
                    { label: 'Kỵ Sĩ', desc: 'Top jockey chuyên nghiệp', icon: '🏇', path: '/rankings' },
                  ].map(item => (
                    <button
                      key={item.label}
                      onClick={() => navigate(item.path)}
            ...
            <div className="relative group">
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium text-slate-300 hover:text-white hover:bg-white/5 transition-all group"
              >
                <TrendingUp className="w-4 h-4 text-[#FFDE42] group-hover:scale-110 transition-transform" />
                Dự Đoán
